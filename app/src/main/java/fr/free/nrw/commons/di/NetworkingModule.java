...
import fr.free.nrw.commons.auth.AuthTokenInterface;
...
public class NetworkingModule {
    ...
    @Provides
    @Singleton
    public AuthTokenInterface provideAuthTokenInterface(@Named(NAMED_COMMONS_WIKI_SITE) WikiSite commonsWikiSite) {
        return ServiceFactory.get(commonsWikiSite, BuildConfig.COMMONS_URL, AuthTokenInterface.class);
    }
